namespace TownApplication.IntegrationTests
{
    public class TownControllerIntegrationTests
    {
        ...
        public void UpdateTown_ShouldUpdatePopulation()
        {
            ...
            var townName = "Sofia";
            var initialPopulation = 111;

            var newPopulation = 333;
            ...
            _controller.UpdateTown(town.Id, newPopulation);
        ...
        public void DeleteTown_ShouldDeleteTown()
        {
            ...
            var townName = "Varna";
            var pop = 333;
            _controller.AddTown(townName,pop);
        ...
        public void ListTowns_ShouldReturnTowns()
        {
            ...
            var townsToAdd = new List<string> {
                "Athens",
                "Thessaloniki",
                "Budapest",
                "Halstadt"
            ...
            {
                _controller.AddTown(town, town.Length * 11);
            }
            ...
            foreach(var town in townsToAdd)
            {
                var townExist = allTowns.FirstOrDefault(x => x.Name == town);
                Assert.NotNull(townExist);
                Assert.Equal(town.Length * 11, townExist.Population);
            }
        }
    }
}
